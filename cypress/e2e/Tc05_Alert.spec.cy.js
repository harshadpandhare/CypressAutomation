...
describe('Handling different alert Functionality', function(){
    ...
    it('Prompt Alert', function(){
        ...
        cy.window().then(function(win){
            cy.stub(win, 'prompt').returns("Hello Prompt Alerts")
            cy.contains('Click for JS Prompt').click()
        })
        cy.get('#result').should('contain', 'You entered: Hello Prompt Alerts')
    })
})